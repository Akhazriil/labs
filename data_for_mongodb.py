class DataMongo:
    ...
    def exist_game(self):
        ...
        game = {'date': '01.01.2023', 'score': '0:2', 'rules violations': f'{violations}', 'goals': f'{goals}',
                'penalties': f'{penalties}', 'shots_number_goals': f'{shots}'}
        return game
    ...
    def exist_teams(self):
        ...
        team = {'name': 'Kyshtym', 'city': 'Kyshtym_team', 'coach_name': 'Leva D.S.', 'players': f'{players}',
                'reserve_players': f'{reserve_players}'}
        return team
